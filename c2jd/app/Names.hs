...
jdKeywords :: [Text]
jdKeywords = ["if", "else", "type", "enum", "struct", "union", "var", "fn", "accessor", "iterator", "const", "alias", "loop", "break", "continue", "ref", "in", "return", "true", "false", "void", "nullptr", "as", "for", "foreach", "and", "or", "yield", "require", "uninitialised", "match", "import", "unsafe", "throw", "try", "catch", "borrow"]
